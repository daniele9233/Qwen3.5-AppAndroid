#!/bin/bash
# Script per push su GitHub - Qwen3.5 Corralejo App
# Esegui: chmod +x push-to-github.sh && ./push-to-github.sh
...
git remote set-url origin https://github.com/daniele9233/Qwen3.5-AppAndroid.git 2>/dev/null || git remote add origin https://github.com/daniele9233/Qwen3.5-AppAndroid.git
